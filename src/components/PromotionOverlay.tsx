...
export default function PromotionOverlay({
    ...
    return (
        ...
        >
            <div
                className="absolute top-0 bg-white shadow-[0_0_10px_rgba(0,0,0,0.5)] flex flex-col"
            ...
            >
                {(['q', 'r', 'n', 'b'] as const).map((p) => {
                    ...
                    return (
                        <button
                            ...
                            className="w-full aspect-square flex items-center justify-center p-0 hover:bg-neutral-500 active:scale-[0.98]"
                ...
                <CloseButton
                    aria-label="Закрыть выбор фигуры"
                    onClick={onClose}
                    m="2"
                />
            </div>
